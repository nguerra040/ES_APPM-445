...
%
% This program cycles through all the values of N and epsilon for the given
% PDE of interest with the given initial data which can be set in line
% 15. The PDE is solved with SSOR with omega=1 to get symmetrized
% Gauss-Seidel. The number of iterations it takes to converge is then
% stored.
